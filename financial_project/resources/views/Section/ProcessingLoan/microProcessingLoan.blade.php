...
<script>
    $(document).ready(function() {
        ...
        $('#ongoinLoan').DataTable({
            ...
            ajax: "{{ route('get-ongoing-micro-Loan') }}",
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var action = '<td>' +
                            ...
                            '">View</a>' +
                            '<a class="dropdown-item  payment-history" data-id="' + data +
                            '">Payment History</a>' +
                            '</div>' +
                            '</div>' +
                            '</td>';
        ...
        $('#overDueLoan').DataTable({
            ...
            ajax: "{{ route('get-overdue-micro-Loan') }}",
        ...
        $('#completedLoan').DataTable({
            ...
            ajax: "{{ route('get-completed-micro-Loan') }}",
            createdRow: function(row, data, dataIndex) {
                endDate = data.end_date;
                var today = new Date();
                today.setHours(0, 0, 0, 0);
