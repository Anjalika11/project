                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card card-default bg-secondary">
                                    <div class="d-flex p-5 align-items-center flex-column">
                                        ...
                                        <h3 class=" d-block text-white">Total Vehicles</h3>
                                        <div class="text-center">
                                            <span class="h2 d-block text-white">{{ $total_vehicles }}</span>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card card-default bg-success">
                                    <div class="d-flex p-5 align-items-center flex-column">
                                        ...
                                        <h3 class=" d-block text-white">Available Vehicles</h3>
                                        <div class="text-center">
                                            <span class="h2 d-block text-white">{{ $available_vehicles }}</span>
                            ...
                            <div class="col-xl-4 col-md-6">
                                <div class="card card-default bg-primary">
                                    <div class="d-flex p-5 align-items-center flex-column">
                                        ...
                                        <h3 class=" d-block text-white">Released Vehicles</h3>
                                        <div class="text-center">
                                            <span class="h2 d-block text-white">{{ $released_vehicles }}</span>
...
<script>
    $(document).ready(function() {
        $('#vehicleList').DataTable({
            ...
            ajax: {
                url: "{{ route('getVehiclemortgagelist') }}",
                type: "GET",
                dataSrc: function(json) {
                    console.log(json); // Log the received data
