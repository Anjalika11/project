                    ...
                    {{-- <div class="row" style="margin: 5px 40px 5px 40px; padding:10px;">
                        ...
                        <div class="col-sm">
                            <label for="middle-name" class="label-align"><span class="required">Ad Outstanding loan to
                                    new loan*</span></label>
                            <li><input type="checkbox" class="checkboxright withoutInterest checkbox--light-blue" />Ad
                                Tick</li>
                        </div>
                        <div class="col-sm">
                            <label for="middle-name" class="label-align"><span class="required">Ad Outstanding loan to
                                    new loan with interest*</span></label>
                            <li><input type="checkbox" class=" checkboxright withInterest checkbox--light-blue" />Ad Tick
                            </li>
                        </div>
                    </div> --}}
                    <div class="row"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle2">Gold Price Calculator</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="col-sm">
                        <label for="middle-name" class="label-align">24K Gold Price<span
                                class="required">*</span></label>
                        <input type="test" id="k24GoldAmount" name="last-name" required="required"
                            class="form-control InterestRate">
                    </div>
                    <div class="col-sm">
                        <label for="middle-name" class="label-align">Astimate Percentage<span
                                class="required">*</span></label>
                        <input type="test" id="AstimatePercentage" name="last-name" required="required"
                            class="form-control InterestRate">
                    </div>
                    <div class="col-sm">
                        <label for="middle-name" class="label-align">Gold Karat<span class="required">*</span></label>
                        <input type="test" id="GoldKarat" name="last-name" required="required"
                            class="form-control InterestRate">
                    </div>
                    <div class="col-sm">
                        <label for="middle-name" class="label-align">Weight<span class="required">*</span></label>
                        <input type="test" id="k24goldWeight" name="last-name" required="required"
                            class="form-control InterestRate">
                    </div>
                    <div class="col-sm">
                        <label for="middle-name" class="label-align">Astimate Price<span
                                class="required">*</span></label>
                        <input type="test" id="AstimatePrice" name="last-name" required="required"
                            class="form-control InterestRate">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btn-pill priceGenarate">Save Changes</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $(document).on('click', '.priceGenarate', function() {
            var k24GoldAmount = parseFloat($('#k24GoldAmount').val());
            var AstimatePercentage = parseFloat($('#AstimatePercentage').val());
            var k24goldWeight = parseFloat($('#k24goldWeight').val());
            var GoldKarat = parseFloat($('#GoldKarat').val());

            var AstimatePriceForPrecentage = (k24GoldAmount / 100) * AstimatePercentage;
            var AstimateKaratePrice = (AstimatePriceForPrecentage / 24) * GoldKarat;
            var AstimatePrice = (AstimateKaratePrice / 8) * k24goldWeight
            $('#AstimatePrice').val(AstimatePrice);
        ...
        $('#example').DataTable({
            ...
            processing: true,
            scrollX: true,
            ajax: "{{ route('get-mortgage-verify-costomer-details') }}",
            columns: [{
                    data: 'id',
                    name: 'id'
                },
        ...
        var ad_previes_outstand = 0;
        $('#withoutInterestCheckbox').change(function() {
            var TotalAmount = 0;
            if ($(this).is(':checked')) {
                ad_previes_outstand = 1;
        ...
        $(document).on('click', '#submitMicroLoan', function() {
            ...
            if (!isValid) {
                ...
                formData.append('ad_previes_outstand', ad_previes_outstand);
                formData.append('LoanId', LoanId);
                formData.append('loan_type', 'mortgageloan');
                formData.append('fixedInterest', fixedInterest);
