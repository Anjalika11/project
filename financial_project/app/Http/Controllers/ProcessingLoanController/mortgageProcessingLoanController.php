...
class mortgageProcessingLoanController extends Controller
{
    public function index()
    {
        return view('Section.ProcessingLoan.mortgageProcessingLoan');
    }
    ...
    public function getCompletedMortagageLoan()
    {
        $branch_id = Session('branch_id');
        $loanDetails = '';
        if(Session('role')=='admin'){
        $loanDetails = Loan::orderby('loans.loanID', 'asc')
            ...
            ->Join('customers', 'loans.customer_id', '=', 'customers.id')
            ->join('loan_types', 'loans.id', '=', 'loan_types.loan_id')
            ->select('loans.*','customers.nic','customers.fullname','loan_payments.pay_amount','loan_payments.due_amount', 'loan_payments.total_amount as totalAmount' , 'loan_payments.capital_amount')
            ->where('loan_types.loan_type', 'mortgageloan')
    ...
    public function getOverdueMortagageLoan(){
        $branch_id = Session('branch_id');
    ...
    public function getCompletedMortgageLoan()
    {
        $branch_id = Session('branch_id');
        $loanDetails = '';
        if(Session('role')=='admin'){
